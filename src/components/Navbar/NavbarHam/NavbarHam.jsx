    ...
    return (
        <>
            ...
            <div ref={hamMenu} className="navbar__ham">
                ...
                <a target='_blank' href='https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcRwPxDZnKhsvccCMhGqJHvXFzmjlCghjCnptQcCVpXsjGXdkldLldBghwZfVkCglMRvjVxnF' className="navbar__link">Abhimanchauhan7@gmail.com</a>
